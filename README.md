...
## Project Scope
A group project while attending the Software Engineering Immersive Course at General Assembly, to build a full-stack web application. The project concept is a renovation tracking app that helps users and contractors monitor project phases.
